/* boost random/uniform_int.hpp header file modified to remove ASSERT
 *
...
#include "Uniform_Int_Distribution_No_Assert.cpp"
...
class uniform_int : public mjd::random::uniform_int_distribution<IntType>
{
  typedef mjd::random::uniform_int_distribution<IntType> base_type;
public:
