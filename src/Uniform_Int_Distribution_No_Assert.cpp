/* boost random/uniform_int_distribution.hpp header file modified to remove asserts
 *
    ...
    boost::mpl::true_ /** is_integral<Engine::result_type> */)
{
  ...
  typedef typename boost::make_unsigned<T>::type range_type;
  typedef typename Engine::result_type base_result;
  // ranges are always unsigned
  typedef typename boost::make_unsigned<base_result>::type base_unsigned;
  const range_type range = boost::random::detail::subtract<result_type>()(max_value, min_value);
...
{
  boost::random::detail::uniform_int_float<Engine> wrapper(eng);
