/* boost random/discrete_distribution.hpp header file (modified to remove assert)
 *
...
#include "Uniform_Int_No_Assert.cpp"
...
public:
    ...
    IntType operator()(URNG& urng) const
    {
        ...
        WeightType test = boost::uniform_01<WeightType>()(urng);
        IntType result = mjd::uniform_int<IntType>((min)(), (max)())(urng);
    ...
    {
        while(true) {
            WeightType val = boost::uniform_01<WeightType>()(urng);
            WeightType sum = 0;
            std::size_t result = 0;
