...
Run_Inference <- function(Number_Of_Iterations = 1000, Base_Alpha =1, Base_Beta = 0.01, Number_Of_Topics = 50, Author_Attributes= author_attributes, Document_Edge_Matrix = document_edge_matrix ,Document_Word_Matrix = document_word_matrix, Vocabulary = vocabulary, Latent_Dimensions = 2, Topic_Step_Itterations = 1, Sample_Step_Itterations = 10, output_file = "Test",Proposal_Variance = 0.5, seed = 1234, output_folder_path = "~/Dropbox/PINLab/", Number_of_Clusters = 10,Itterations_Before_Cluster_Assingment_Updates = 5, Adaptive_Metropolis_Target_Accept_Rate = 0.3, slice_sample_alpha_step_size = 1, Slice_Sample_Alpha = F, MH_prior_standard_deviation = 2, Number_of_Binary_Mixing_Parameters = 1, Mixing_Variable = "Gender"){
