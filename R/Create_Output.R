...
#' @param estimation_output_list If you prefer to provide a list object where each entry is the object returned by the Run_Full_Model() function. This is a way to circumvent reading in files from disk if we want to keep all information in our current R session.
