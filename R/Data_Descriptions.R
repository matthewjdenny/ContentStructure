...
#' @format A a number of emails (121) by number of unique terms (221) dataframe that records the number of times each term was used in each email.
NULL
...
#'   
#' \itemize{
#'   \item a vector containing all unique terms.
#' }
#'
#' @docType data
#' @keywords datasets
