# ContentStructure [![Travis-CI Build Status](https://travis-ci.org/matthewjdenny/ContentStructure.svg?branch=master)](https://travis-ci.org/matthewjdenny/ContentStructure)
